  ...
  return (
    <div className="fixed inset-0 flex flex-col items-center justify-center bg-gradient-to-br from-green-50 to-white z-50 transition-opacity duration-1000 ease-in-out">
      <div className="relative mb-6 group">
        ...
        <div className="absolute -inset-4 rounded-full border-2 border-green-200 opacity-0 group-hover:opacity-100 animate-pulse-slow transition-all duration-1000"></div>
      </div>
      ...
      <div className="h-20 flex items-center justify-center">
        <h1 className="text-5xl font-bold bg-gradient-to-r from-green-600 to-green-400 bg-clip-text text-transparent tracking-tight mb-2 relative">
          <span className="relative overflow-hidden whitespace-nowrap">
            <span className="text-green-600 inline-block animate-typing overflow-hidden whitespace-nowrap pr-1 border-r-4 border-green-400 animate-[blink-caret_0.75s_step-end_infinite]">
      ...
      <p className="text-gray-500 text-lg animate-fadeIn delay-500 mt-2">
